...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    do {
        ...
        $sql = "INSERT INTO tb_user (firstname, surname, birthdate, email, password) VALUES ('$firstname', '$surname', '$birthdate', '$email', '$password')";
...
if (!$result){
    ...
    break;
        ...
        $successMessage ="User added to database.";
